...
@Named
public class TradeMarkDataLoader extends DataLoader {
	private static final Logger LOGGER = Logger.getLogger(TradeMarkDataLoader.class.getName());
	@Inject
	...
	public void loadResource() {
		...
		brandTerms = fileLoader.loadResource(tradeMarkFile);
