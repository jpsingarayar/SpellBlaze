...
public class PrefixProximity {
	
	/**
	 * Specifies the threshold used to determine when Winkler bonus should be
	 * used. Set to a negative value to get the Jaro distance.
	 * 
